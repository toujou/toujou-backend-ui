...
export default {
    title: 'Content Elements / Text / Three Text Blocks With Media Above',
    component: 'text',
};
    ...
    return html`
        <tbeui-page-column header-name="Content area">
            ...
            <tbeui-page-ce-element
                slot="content"
                ctype-name="Three text block with media above"
                id="col-1"
...
export const ThreeTextBlocksWithMediaAbove = Template.bind({});
