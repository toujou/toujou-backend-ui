...
export default {
    title: 'Content Elements / Text / Two Text Blocks With Media Below',
    component: 'text',
};
    ...
    return html`
        <tbeui-page-column header-name="Content area">
            ...
            <tbeui-page-ce-element
                slot="content"
                ctype-name="Two text block with media below"
                id="col-1"
                column-layout="50-50"
            >
...
export const TwoTextBlocksWithMediaBelow = Template.bind({});
