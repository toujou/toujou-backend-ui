...
export default {
    title: 'Content Elements / Text / Four Text Blocks With Media Below',
    component: 'text',
};
    ...
    return html`
        <tbeui-page-column header-name="Content area">
            ...
            <tbeui-page-ce-element
                slot="content"
                ctype-name="Four text block with media below"
                id="col-1"
...
export const FourTextBlocksWithMediaBelow = Template.bind({});
