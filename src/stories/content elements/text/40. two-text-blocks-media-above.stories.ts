...
export default {
    title: 'Content Elements / Text / Two Text Blocks With Media Above',
    component: 'text',
};
    ...
    return html`
        <tbeui-page-column header-name="Content area">
            ...
            <tbeui-page-ce-element
                slot="content"
                ctype-name="Two text block with media above"
                id="col-1"
                column-layout="50-50"
            >
...
export const TwoTextBlocksWithMediaAbove = Template.bind({});
